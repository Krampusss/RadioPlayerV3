...
async def main():
    async with bot:
        ...
        try:
            await USER.join_chat("International_chatting_Legends")
...
bot.run(main())
bot.start()
print("\n\nRadio Player Bot Started, Join @International_chatting_Legends!")
bot.send(
...
async def restart(_, message: Message):
    ...
    try:
        await k.edit("✅ **Restarted Successfully! \nJoin @International_chatting_Legends For Update!**")
        await k.reply_to_message.delete()
    except:
        pass

idle()
print("\n\nRadio Player Bot Stopped, Join @International_chatting_Legends!")
bot.stop()
